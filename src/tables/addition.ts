const additionStartBtn = document.getElementById("startBtn") as HTMLButtonElement;
const additionResetBtn = document.getElementById("resetBtn") as HTMLButtonElement;
const additionQuizContainer = document.getElementById("quizContainer") as HTMLDivElement;
...
function generateRandomAdditionNumber(): number {
